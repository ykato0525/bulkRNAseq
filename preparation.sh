...
# chr1-22, X, Y, Mにする
wget https://kero.hgc.jp/book/DSTEP_ProgramII_input_2020/data/sc
ript/reference.pl

perl reference.pl ~/RNAseq_analyzer/data/Homo_sapiens/UCSC/hg38/
Sequence/WholeGenomeFasta/genome.fa genome.fa
